export const metadata = { title: 'Get Started', description: 'Book a discovery call with Solomon Media Group and explore a growth system built around your business.' };
  ...
  return (
    <main className="page">
      <div className="shell">
        ...
        <section>
          <div className="grid">
            <div className="card"><span className="num">01</span><h3>Tell us where you are</h3><p>What you sell, who you serve, and how customers currently find you.</p></div>
            <div className="card"><span className="num">02</span><h3>Define the target</h3><p>We look at the kind of leads, jobs, and revenue you actually want.</p></div>
            <div className="card"><span className="num">03</span><h3>Map the system</h3><p>We&apos;ll determine whether SMG can build a better path from demand to booked opportunity.</p></div>
          </div>
          <div className="cal-section">
            <div className="cal-copy"><span className="tag">BOOK A DISCOVERY CALL</span><h2>Let&apos;s talk.</h2><p>Choose a time that works for you. We&apos;ll use the call to understand your business and determine where SMG can help.</p></div>
