...
export default function GetStartedForm() {
  ...
  if (submitted) {
    return (
      <div className="start-form-success">
        <span className="tag">THANK YOU</span>
  ...
  return (
    <form className="start-form" onSubmit={handleSubmit}>
      <div className="start-form-heading">
        <span className="tag">TELL US ABOUT THE BUSINESS</span>
      ...
      <label className="field">
        ...
        <textarea name="context" className="short-textarea" placeholder="Current setup, sales process, call volume, lead flow, etc." />
      </label>
